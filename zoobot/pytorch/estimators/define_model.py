...
class GenericLightningModule(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        return torch.optim.Adam(self.parameters(), lr=0.0001, betas=(0.9, 0.999))  
...
def get_plain_pytorch_zoobot_model(
    ...
    # modules_to_use.append(custom_layers.WandBLog(log_string='input_images', batch_to_image=True))
